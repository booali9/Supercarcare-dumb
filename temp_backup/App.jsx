...
import ServiceSelectionForm from "./Timeassign/ServicesPage";
...
function Layout({ children, activeStep }) {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Stepper (only show on non-home pages) */}
      {!isHomePage && !isContactPage && !isSignupPage && !isLoginPage && !isAccount&&!isAdmin && !isShop && !isWhyUsPage && !isFinancingPage && <Stepper className="pt-32 mt-34" activeStep={activeStep} />}
      ...
      <motion.main
        ...
        className={`flex-grow bg-white ${isHomePage ? 'pt-32' : 'pt-32'}`}
      >
        {children}
      </motion.main>
...
function App() {
  ...
  return (
    <div className="relative min-h-screen">
      {/* Global Maroon Grid Background */}
      <div className="bg-maroon-grid z-0" />
      <div className="bg-maroon-glow z-0" />
