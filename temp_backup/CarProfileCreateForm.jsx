...
import { createCarProfile } from "./graphql/mutations";
const client = generateClient();
export default function CarProfileCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setModelYear(initialValues.modelYear);
    setTrim(initialValues.trim);
    setVinNumber(initialValues.vinNumber);
    setTireSpecifications(initialValues.tireSpecifications);
    setWheelSpecifications(initialValues.wheelSpecifications);
    setErrors({});
  };
  const validations = {
    make: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createCarProfile.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "CarProfileCreateForm")}
      {...rest}
    >
      <TextField
        label="Make"
