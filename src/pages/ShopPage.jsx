...
const mockProducts = [
  {
    id: 1,
    icon: <FiSettings className="text-ferrari text-3xl" />,
  ...
  {
    id: 2,
    icon: <FiAward className="text-ferrari text-3xl" />,
  ...
  {
    id: 3,
    icon: <FiShield className="text-ferrari text-3xl" />,
  ...
  {
    id: 4,
    icon: <FiUsers className="text-ferrari text-3xl" />,
  ...
  {
    id: 5,
    icon: <FiTool className="text-ferrari text-3xl" />,
    title: 'Brake Service',
    ...
    <div className="min-h-screen relative bg-black py-16 px-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-extrabold text-ferrari mb-4 drop-shadow-lg flex items-center justify-center gap-3">
            <FiShoppingCart className="inline-block text-ferrari text-5xl mb-1" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {mockProducts.map(product => (
            <div
              key={product.id}
              className="bg-[#181818] border border-ferrari rounded-2xl shadow-lg p-8 flex flex-col items-start transition-all hover:shadow-[0_0_24px_4px_rgba(220,20,60,0.25)] hover:-translate-y-1 duration-200 group"
            >
              <div className="mb-4">{product.icon}</div>
              <h2 className="text-2xl font-bold text-ferrari mb-2 group-hover:drop-shadow-[0_0_8px_rgba(220,20,60,0.7)] transition-all">{product.title}</h2>
              ...
              <div className="flex items-center justify-between w-full mt-auto">
                ...
                <button
                  className="bg-ferrari text-white px-6 py-2 rounded-lg font-semibold hover:bg-ferrari/90 transition shadow-lg hover:shadow-ferrari/40 flex items-center gap-2"
